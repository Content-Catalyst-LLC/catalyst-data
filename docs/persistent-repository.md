...
Catalyst Data v1.6.0 uses SQLite as its zero-cost local repository. The Python service applies ordered migrations from `python/catalyst_data/migrations` and stores each canonical record in two synchronized forms:

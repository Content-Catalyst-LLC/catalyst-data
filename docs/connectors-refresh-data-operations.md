...
Catalyst Data v1.11.0 introduces a governed acquisition layer for recurring external and local data. Connectors remain subordinate to the canonical record, review, provenance, and workspace contracts: a connector may import and refresh evidence, but it cannot silently approve or publish a record.

-- Catalyst Data v3.0.0 PostgreSQL schema
...
-- migration 023_connected_data_graph_cross_source_federation
...
DROP TRIGGER IF EXISTS catalyst_immutable_connected_graph_edge_events ON connected_graph_edge_events;
CREATE TRIGGER catalyst_immutable_connected_graph_edge_events BEFORE UPDATE OR DELETE ON connected_graph_edge_events FOR EACH ROW EXECUTE FUNCTION catalyst_reject_mutation();
DROP TRIGGER IF EXISTS catalyst_immutable_connected_graph_sync_runs ON connected_graph_sync_runs;
CREATE TRIGGER catalyst_immutable_connected_graph_sync_runs BEFORE UPDATE OR DELETE ON connected_graph_sync_runs FOR EACH ROW EXECUTE FUNCTION catalyst_reject_mutation();

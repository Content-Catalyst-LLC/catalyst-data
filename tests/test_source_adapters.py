...
def test_builtin_adapter_registry_exposes_governed_manifests():
    ...
    assert [item["adapter_id"] for item in manifests] == ["generic-http-csv", "generic-http-json", "internet-archive-metadata", "internet-archive-search", "un-sdg-geoareas", "un-sdg-goals", "un-sdg-indicator-data", "un-sdg-indicators", "us-bea-data", "us-bls-series", "us-census-data", "us-eia-data", "us-epa-envirofacts", "us-usgs-water-data", "wayback-availability", "wayback-cdx", "world-bank-countries", "world-bank-indicator-data", "world-bank-indicators"]

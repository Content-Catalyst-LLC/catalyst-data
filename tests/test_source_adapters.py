...
def test_builtin_adapter_registry_exposes_governed_manifests():
    ...
    assert [item["adapter_id"] for item in manifests] == ["erddap-tabledap-json", "generic-http-csv", "generic-http-json", "internet-archive-metadata", "internet-archive-search", "ioos-data-catalog", "jpl-sbdb-close-approach", "jpl-sbdb-query", "nasa-donki-space-weather", "nasa-exoplanet-tap", "noaa-erddap-catalog", "noaa-ncei-cdo-v2", "un-sdg-geoareas", "un-sdg-goals", "un-sdg-indicator-data", "un-sdg-indicators", "us-bea-data", "us-bls-series", "us-census-data", "us-eia-data", "us-epa-envirofacts", "us-usgs-water-data", "usgs-earthquake-fdsn", "wayback-availability", "wayback-cdx", "world-bank-countries", "world-bank-indicator-data", "world-bank-indicators"]

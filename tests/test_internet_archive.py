...
def test_search_persists_catalog_without_measurement_coercion(tmp_path):
    ...
    assert result['num_found']==1; assert svc.items(query='Energy')[0]['item_identifier']=='energy_test'; assert calls[0].headers['User-agent'].startswith('SustainableCatalyst-CatalystData/3.0.0')
